...
interface SubjectApi {
    ...
    suspend fun updateGeneralInformation(@Path("subjectId") subjectId: String, @Path("generalInformationId") generalInformationId: String, @Body generalInformationDto: GeneralInformationDto): Response<GeneralInformation>
    ...
    suspend fun updateHealthConditionItem(@Path("subjectId") subjectId: String, @Path("healthConditionId") healthConditionId: String, @Path("healthConditionItemId") healthConditionItemId: String, @Body healthConditionItemDto: HealthConditionItemDto): Response<HealthConditionItem>
    ...
    suspend fun updateFunctionAbilityItem(@Path("subjectId") subjectId: String, @Path("functionAbilityId") functionAbilityId: String, @Path("functionAbilityItemId") functionAbilityItemId: String, @Body functionAbilityItemDto: FunctionAbilityItemDto) : Response<FunctionAbilityItem>
}